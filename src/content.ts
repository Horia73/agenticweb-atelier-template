...
export const site = {
  ...
  booking: {
    ...
    text: "Acesta este un formular demonstrativ. Nu transmite și nu stochează date; integrarea AgenticWeb va fi adăugată într-o etapă ulterioară.",
    ...
    submit: "Trimite cererea demonstrativă",
    successTitle: "Cererea demonstrativă a fost înregistrată local.",
    successText: "Nicio informație nu a fost transmisă. În fluxul final, cererea va trebui confirmată ulterior pe email.",
    reset: "Reia formularul",
    privacy: "Prin testarea formularului accepți doar simularea locală; datele nu părăsesc această pagină.",
  },
  footer: {
