...
export function BookingForm() {
  ...
  return (
    <form data-booking-form="local-demo" data-hydrated={hydrated} aria-busy={!hydrated} onSubmit={handleSubmit}>
      <fieldset disabled={!hydrated} className="space-y-5 disabled:opacity-70">
