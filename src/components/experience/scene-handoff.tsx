...
function HandoffLayers({
  ...
  const seamOpacity = useTransform(progress, [0, 0.28, 0.58, 0.86, 1], [0, 0, 1, 0, 0]);
  const seamScaleX = useTransform(progress, [0, 0.28, 0.78], [0.05, 0.05, 1]);
  ...
  return (
    <>
      ...
      <motion.div
        aria-hidden
        className="pointer-events-none absolute inset-x-[7%] top-1/2 h-px bg-white/70 shadow-[0_0_26px_6px_rgba(255,255,255,.32)]"
