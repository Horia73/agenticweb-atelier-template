...
Testează exact progresul 0 și 1, seam-ul la 25/50/75%, reverse-scroll, scroll rapid, hover leave, crop-uri foarte diferite, 390/768/1440 px, reduced motion, context loss și absența benzilor, marginilor negre sau flash-urilor luminoase.
