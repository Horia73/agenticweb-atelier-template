...
- Formularul este dezactivat în HTML-ul inițial până la montarea graniței client, apoi oprește submit-ul implicit și trimite un singur POST JSON către endpointul public AgenticWeb de lead. Cheia publică embed este transmisă în proprietatea canonică `key`; payloadul include sesiunea în `meta`, pagina curentă și honeypot-ul `website`, iar URL-ul paginii rămâne neschimbat.
